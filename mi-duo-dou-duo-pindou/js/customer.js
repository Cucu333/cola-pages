...
function requestExtra() { if (getExtraRequests()[currentSeatId]) return; customerIronFormOpen = false; customerExtraFormOpen = !customerExtraFormOpen; renderCustomerView(); }
...
function openIronForm() { customerExtraFormOpen = false; pendingCustomerIronMode = getIronModes()[0] || '普通熨烫'; customerIronFormOpen = true; renderCustomerView(); }
